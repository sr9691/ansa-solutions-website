	...
	<section class="section section--final-cta section--cta-dark" id="book-demo">
		<div class="container">
			<div style="max-width: 800px; margin: 0 auto; text-align: center;">
				...
				<p style="color: rgba(255,255,255,0.8); font-size: 1.05rem; margin-bottom: 2rem;">Pick a time that works for you and we'll walk you through a live demo tailored to your team.</p>
				<style>
